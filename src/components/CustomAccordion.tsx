  ...
  return (
    <div>
      <div className="border rounded-lg shadow-md transition-all duration-500 ease-in-out bg-[#B3E5FC] backdrop-blur-[2px] w-full">
        ...
        >
          <h3 className="text-lg font-semibold text-slate-700 text-left w-full">
        ...
        >
          <div className="p-4 text-slate-700 text-left bg-[#B3E5FC]">
            <ul className="list-disc pl-5">
              ...
              <li>
                <strong>List What You Need:</strong> Mention the fields (e.g., name, email) and their types (e.g., text, checkbox).
              </li>
              <li>
                <strong>Note Any Conditions:</strong> If some fields depend on others, mention it.
              </li>
              <li>
